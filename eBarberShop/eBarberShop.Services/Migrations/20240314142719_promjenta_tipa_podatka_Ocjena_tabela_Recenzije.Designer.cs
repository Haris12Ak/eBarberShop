...
namespace eBarberShop.Services.Migrations
{
    ...
    [Migration("20240314142719_promjenta_tipa_podatka_Ocjena_tabela_Recenzije")]
    partial class promjenta_tipa_podatka_Ocjena_tabela_Recenzije
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eBarberShop.Services.Database.Korisnici", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Ime = "Admin",
                            KorisnickoIme = "admin",
                            LozinkaHash = "ugYRpSCP8XZYOBzItpvGr8R9mBg=",
                            LozinkaSalt = "nTzA85SUSzR7XxZGZVfwKg==",
                            Prezime = "Admin"
                        },
                        new
                        {
                            ...
                            LozinkaHash = "8KlkZegsjG4dZr1limCsfJ7S1UI=",
                            LozinkaSalt = "2A8lbfScvlCaX4mRgeb0rg==",
                            Prezime = "Uposlenik"
                        },
                        new
                        {
                            ...
                            Ime = "Test",
                            KorisnickoIme = "test",
                            LozinkaHash = "Yvs0mh/5ZD9SyHY2nSYmFqxZf78=",
                            LozinkaSalt = "EGY3u1vtdQKhRt9KM54CJA==",
                            Prezime = "Test"
                        },
                        new
                        {
                            ...
                            LozinkaHash = "Jj4n4DxrmUeOc76oEvDYdJByoUw=",
                            LozinkaSalt = "CdJ4oY8jsogBmIFLTZ4kKA==",
                            Prezime = "Klijent"
                        });
                });
            ...
            modelBuilder.Entity("eBarberShop.Services.Database.KorisniciUloge", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            KorisniciUlogeId = 1,
                            DatumIzmjene = new DateTime(2024, 3, 14, 15, 27, 19, 589, DateTimeKind.Local).AddTicks(2120),
                            KorisnikId = 1,
                            UlogaId = 1
                        },
                        new
                        {
                            KorisniciUlogeId = 2,
                            DatumIzmjene = new DateTime(2024, 3, 14, 15, 27, 19, 589, DateTimeKind.Local).AddTicks(2222),
                            KorisnikId = 2,
                            UlogaId = 2
                        },
                        new
                        {
                            KorisniciUlogeId = 3,
                            DatumIzmjene = new DateTime(2024, 3, 14, 15, 27, 19, 589, DateTimeKind.Local).AddTicks(2225),
                            KorisnikId = 3,
                            UlogaId = 3
                        },
                        new
                        {
                            KorisniciUlogeId = 4,
                            DatumIzmjene = new DateTime(2024, 3, 14, 15, 27, 19, 589, DateTimeKind.Local).AddTicks(2228),
                            KorisnikId = 4,
                            UlogaId = 3
                        });
                });
            ...
            modelBuilder.Entity("eBarberShop.Services.Database.Narudzbe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            NarudzbeId = 1,
                            BrojNarudzbe = "000001",
                            DatumNarudzbe = new DateTime(2024, 3, 14, 15, 27, 19, 589, DateTimeKind.Local).AddTicks(2582),
                            KorisnikId = 3,
                            Otkazano = false,
                            Status = true,
                            UkupanIznos = 8m
                        ...
                        new
                        {
                            NarudzbeId = 2,
                            BrojNarudzbe = "000002",
                            DatumNarudzbe = new DateTime(2024, 3, 14, 15, 27, 19, 589, DateTimeKind.Local).AddTicks(2588),
                            KorisnikId = 3,
                            Otkazano = false,
                            Status = true,
                            UkupanIznos = 16m
                        ...
                        new
                        {
                            NarudzbeId = 3,
                            BrojNarudzbe = "000003",
                            DatumNarudzbe = new DateTime(2024, 3, 14, 15, 27, 19, 589, DateTimeKind.Local).AddTicks(2591),
                            KorisnikId = 4,
                            Otkazano = false,
                            Status = true,
                            UkupanIznos = 6m
                        ...
                        new
                        {
                            NarudzbeId = 4,
                            BrojNarudzbe = "000004",
                            DatumNarudzbe = new DateTime(2024, 3, 14, 15, 27, 19, 589, DateTimeKind.Local).AddTicks(2595),
                            KorisnikId = 4,
                            Otkazano = false,
                            Status = true,
                            UkupanIznos = 7.5m
            ...
            modelBuilder.Entity("eBarberShop.Services.Database.Novosti", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            NovostiId = 1,
                            DatumObjave = new DateTime(2024, 3, 14, 15, 27, 19, 589, DateTimeKind.Local).AddTicks(2252),
                            KorisnikId = 1,
                        ...
                        {
                            NovostiId = 2,
                            DatumObjave = new DateTime(2024, 3, 14, 15, 27, 19, 589, DateTimeKind.Local).AddTicks(2256),
                            KorisnikId = 1,
                        ...
                        {
                            NovostiId = 3,
                            DatumObjave = new DateTime(2024, 3, 14, 15, 27, 19, 589, DateTimeKind.Local).AddTicks(2259),
                            KorisnikId = 1,
            ...
            modelBuilder.Entity("eBarberShop.Services.Database.Recenzije", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RecenzijeId = 1,
                            DatumObjave = new DateTime(2024, 3, 14, 15, 27, 19, 589, DateTimeKind.Local).AddTicks(2361),
                            KorisnikId = 3,
                            Ocjena = 5.0,
                        ...
                        {
                            RecenzijeId = 2,
                            DatumObjave = new DateTime(2024, 3, 14, 15, 27, 19, 589, DateTimeKind.Local).AddTicks(2366),
                            KorisnikId = 4,
                            Ocjena = 4.0,
