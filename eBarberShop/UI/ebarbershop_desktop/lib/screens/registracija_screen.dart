...
import 'package:ebarbershop_desktop/models/korisnik/korisnik_insert_request.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading
          ...
          : Container(
              margin: const EdgeInsets.fromLTRB(300.0, 20.0, 300.0, 20.0),
                    ...
                    Align(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: _imeController.text != "" &&
                            ...
                            ? () async {
                                var korisnikProvider =
                                    Provider.of<KorisnikProvider>(context,
                                        listen: false);
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          padding: const EdgeInsets.fromLTRB(30.0, 18.0, 30.0, 18.0)
                        ),
                        label: const Text(
                          'Spremi',
